<x-layouts.ecommerce title="Home">
    <!-- banner -->
    <div class="bg-cover bg-no-repeat bg-center py-36" style="background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('{{ asset('assets/ecommerce/images/banner-bg.jpg') }}');">
        <div class="container">
            ...
            <p class="text-white">
                ...
                consectetur culpa laborum odit tempora expedita.
            </p>
            <div class="mt-12">
    ...
    <div class="container py-16">
        <div class="w-10/12 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-center">
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="{{ asset('assets/ecommerce/images/icons/delivery-van.svg') }}" alt="Delivery" class="w-12 h-12 object-contain">
                <div>
            ...
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="{{ asset('assets/ecommerce/images/icons/money-back.svg') }}" alt="Delivery" class="w-12 h-12 object-contain">
                <div>
            ...
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="{{ asset('assets/ecommerce/images/icons/service-hours.svg') }}" alt="Delivery" class="w-12 h-12 object-contain">
                <div>
    ...
    <div class="container py-16">
        ...
        <div class="grid grid-cols-3 gap-3">
            <div class="relative rounded-sm overflow-hidden group">
                <img src="{{ asset('assets/ecommerce/images/category/category-1.jpg') }}" alt="category 1" class="w-full">
            ...
            <div class="relative rounded-sm overflow-hidden group">
                <img src="{{ asset('assets/ecommerce/images/category/category-2.jpg') }}" alt="category 1" class="w-full">
            ...
            <div class="relative rounded-sm overflow-hidden group">
                <img src="{{ asset('assets/ecommerce/images/category/category-3.jpg') }}" alt="category 1" class="w-full">
            ...
            <div class="relative rounded-sm overflow-hidden group">
                <img src="{{ asset('assets/ecommerce/images/category/category-4.jpg') }}" alt="category 1" class="w-full">
            ...
            <div class="relative rounded-sm overflow-hidden group">
                <img src="{{ asset('assets/ecommerce/images/category/category-5.jpg') }}" alt="category 1" class="w-full">
            ...
            <div class="relative rounded-sm overflow-hidden group">
                <img src="{{ asset('assets/ecommerce/images/category/category-6.jpg') }}" alt="category 1" class="w-full">
    ...
    <div class="container pb-16">
        <a href="#">
            <img src="{{ asset('assets/ecommerce/images/offer.jpg') }}" alt="ads" class="w-full">
        </a>
    </div>
    <!-- ./ads -->
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
                    @if($product->image)
                        <img src="{{ asset('storage/' . $product->image) }}" alt="product" class="w-full h-64 object-cover">
                    @else
                        <img src="{{ asset('assets/ecommerce/images/products/product2.jpg') }}" alt="product" class="w-full h-64 object-cover">
                    @endif
                    <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                        justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition" title="view product">
